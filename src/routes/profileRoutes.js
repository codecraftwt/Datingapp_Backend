...
router.all(['/online-users', '/online'], auth, profileController.getOnlineUsers);
router.all(['/presence', '/presence-heartbeat'], auth, profileController.updatePresence);
router.all('/online-status', auth, profileController.getOnlineStatusMap);
